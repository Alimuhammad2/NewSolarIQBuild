...
//             <CardDescription>Get started with your solar journey today</CardDescription>
//           </CardHeader>
//           <CardContent>
...
import { Link, useNavigate } from 'react-router-dom';
import { Sun, Mail, Lock, User, ArrowRight } from 'lucide-react';
import axios from 'axios'; // Axios Import Kiye
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';
...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Account bante hi login page par redirection
      setTimeout(() => {
        navigate('/login');
      }, 1500);
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Must be a secure number format sequence</p>
              </div>
